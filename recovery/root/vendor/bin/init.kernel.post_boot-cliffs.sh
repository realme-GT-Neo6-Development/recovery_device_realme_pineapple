...
case "$variant" in
	"3_4_1")
	/system/bin/sh /vendor/bin/init.kernel.post_boot-cliffs_default_3_4_1.sh
	;;
	"3_3_1")
	/system/bin/sh /vendor/bin/init.kernel.post_boot-cliffs_3_3_1.sh
	;;
	"2_3_0")
	/system/bin/sh /vendor/bin/init.kernel.post_boot-cliffs_2_3_0.sh
	;;
	"2_2_1")
